...
export default function TitleScreen({ onStart, onSettings, onCredits, hasSave, onContinue }) {
  ...
  return (
    <div className="title-screen">
      <div className={`title-screen__header${showTitle ? " title-screen__header--visible" : " title-screen__header--hidden"}`}>
        ...
        <p className={`title-screen__subtitle${showSub ? " title-screen__subtitle--visible" : " title-screen__subtitle--hidden"}`}>
          UN RACCONTO INTERATTIVO
        </p>
      </div>

      <div className="title-screen__menu">
        {hasSave && <MenuBtn label="Continua" onClick={onContinue} delay={900} />}
        <MenuBtn label="Nuova Partita" onClick={onStart}    delay={hasSave ? 1200 : 1200} />
        <MenuBtn label="Impostazioni"  onClick={onSettings} delay={hasSave ? 1500 : 1500} />
        <MenuBtn label="Crediti"       onClick={onCredits}  delay={hasSave ? 1800 : 1800} />
      </div>
